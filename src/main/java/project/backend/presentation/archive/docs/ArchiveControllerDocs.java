...
public interface ArchiveControllerDocs {
  ...
  @Operation(summary = "아카이브 상세 조회 API", description = "특정 아카이브의 상세 정보를 조회합니다.")
  @Parameter(name = "userInfo", hidden = true)
  @Parameter(name = "archiveId", description = "조회할 아카이브의 ID")
  ResponseEntity<ArchiveDetailResponse> getArchiveDetail(CurrentUserInfo userInfo, Long archiveId);
